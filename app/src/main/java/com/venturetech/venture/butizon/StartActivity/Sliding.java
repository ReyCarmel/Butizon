...
public class Sliding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = new PreferenceManage(this);//Manager(this);
        ...
        layouts = new int[]{
                R.layout.activity_welcome,R.layout.choosing,R.layout.choose,
...
//        prefManager.setFirstTimeLaunch(false);
        ...
        prefManager.setFirstTimeLaunch(false);
            startActivity(new Intent(Sliding.this, ClubLogin.class));
            finish();
    ...
    private void launchHomeScreenn() {
        prefManager.setFirstTimeLaunch(false);
        startActivity(new Intent(Sliding.this, ClubLogin.class));
        finish();
    }
